...
pub fn handle_grpc_methods(attr: TokenStream, item: TokenStream) -> Result<TokenStream> {
    ...
    let wrapper_def = quote! {
        ...
        pub struct #wrapper_ident {
            source: ::ulo::traits_helpers::DispatchSource<#self_ident>,
    ...
    let grpc_trait_impl = quote! {
        #[doc(hidden)]
        pub struct #source_ident(::ulo::traits_helpers::DispatchSource<#self_ident>);
        ...
        impl #self_ident {
            ...
            pub fn __ulo_dispatch(
                ...
                ::ulo::traits_helpers::Dispatch::Grpc(
